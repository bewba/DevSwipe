...
<main class="min-h-screen bg-gray-900 flex items-center justify-center px-4 py-12">
    <div class="bg-gray-800 p-8 rounded-xl shadow-lg w-1/2 max-w-md border border-gray-700">
        <h1 class="text-3xl font-bold text-center mb-8 text-white">Welcome Back</h1>
        ...
        <form on:submit|preventDefault={handleSubmit} class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="/forgot-password" class="text-sm text-cyan-400 hover:text-cyan-300">Forgot password?</a>
            </div>
        ...
        <p class="text-center mt-6 text-gray-400">
            ...
            <a href="/signup" class="text-cyan-400 hover:text-cyan-300">Sign up</a>
        </p>
    </div>
</main>
